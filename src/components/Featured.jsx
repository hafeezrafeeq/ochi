...
function Featured({ image, whiteDoth, btnText }) {

    return (
        <div className='w-full px-6 md:px-12 lg:px-14 font-[r-neue] py-20 text-black bg-[#f1f1f1]'>
            <h1 className='text-[4vw] pb-4x border-b-2 border-[#b2b2b2]'>Featured projects</h1>
