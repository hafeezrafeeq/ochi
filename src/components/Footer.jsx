...
function Footer() {
    ...
    return (
        <div data-scroll data-scroll-speed='.4' data-scroll-section 
         className='w-full h-screen bg-[#f1f1f1] flex'>
            ...
            <div className='w-[50%] p-12 mr-[2vw] flex flex-col justify-between'>
                <h1 className='font-[founders]  text-[8vw] leading-30 text-end uppercase text-black'>presentations</h1>
                <motion.div
                ...
                >
                    <h3 className="text-black text-end font-[founders] text-6xl mb-[4vw]">
                        Social Link
                    </h3>
                    ...
                    {links.map((item, index) => (
                        <motion.a
                            ...
                            whileHover="hovered"
                            animate="rest"
                            className="relative text-black text-end text-4xl mt-[1vw] no-underline transition-colors hover:text-gray-800"
                        >
                            {item.name}
