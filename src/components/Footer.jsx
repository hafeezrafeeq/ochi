...
function Footer() {
    const links = [
        { name: "LinkedIn", link: "https://www.linkedin.com/in/hafeezrafeeq/" },
        { name: "Facebook", link: "https://www.facebook.com/" },
        { name: "Behance", link: "https://www.behance.net/hafeezrafeeq2" },
        { name: "GitHub", link: "https://github.com/hafeezrafeeq" },
    ];
        ...
        <section data-scroll-section className=''>
            <div data-scroll data-scroll-speed='-0.1' >
                <div className='w-full min-h-screen bg-[#f1f1f1] flex z-999'>
                    ...
                    <div className='w-[50%] p-12 mr-[2vw] flex flex-col justify-between'>
                        <h1 className='font-[founders]  text-[8vw] leading-30  uppercase text-black'>presentations</h1>
                        <div className='flex gap-[18vw] items-end'>
                            <motion.div
                            ...
                            >
                                <h3 className="text-black font-[r-neue] text-xl mb-[1vw]">
                                    Social Link
                                </h3>
                                ...
                                {links.map((item, index) => (
                                    <motion.a
                                        ...
                                        whileHover="hovered"
                                        animate="rest"
                                        className="relative text-black w-20 text-lg mt-[0.2vw] no-underline transition-colors hover:text-gray-800"
                                    >
                                        {item.name}
                                        ...
                                        <motion.span
                                            ...
                                            className="absolute left-0 bottom-0 h-[2px] bg-zinc-800"
                                        />
                                    </motion.a>
                                ))}
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                className="hidden md:flex gap-4 text-md text-black border-black font-[r-neue]"
                            >
                                {[
                                    { name: "Home", link: "#home" },
                                    ...
                                    (item, index) => (
                                        ...
                                        >
                                            ...
                                            <motion.span
                                                ...
                                                className="absolute left-0 bottom-0 bg-zinc-800 h-[1.5px] "
                                            />
                                        </motion.a>
                                    )
                                )}
