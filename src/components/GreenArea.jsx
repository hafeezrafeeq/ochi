...
function GreenArea() {
  return (
    <div data-scroll  data-scroll-speed='.4' data-scroll-section className='greenAria rounded-tl-4xl rounded-tr-4xl bg-[#004d43] h-[31.5vw] scroll-auto overflow-hidden whitespace-nowrap flex  items-center'>
